...
public class ImageLoaderUtils implements IImageLoader {
    ...
    @Override
    public void downloadImage(Context context, String url, final String targetPath, OnDownloadImageListener onDownloadImageListener) {
        imageLoader.downloadImage(context, url, targetPath, onDownloadImageListener);
    }
}
